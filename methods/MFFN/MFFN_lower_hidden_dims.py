...
class CAMV(nn.Module):
    def __init__(self, in_dim, mm_size):
        ...
        # NOTE: paraameter intialization interesting
    ...
    def forward(self, c1, o, c2, a1, a2, return_feats=False):
        ...
        attn = self.trans(torch.cat([c1, m, c2], dim=1)) # NOTE: Trans layer
...
class CFU(nn.Module):
    def __init__(self, in_c, num_groups=4, hidden_dim=None):
        ...
        self.fp = Progressive_Iteration(96)
...
@MODELS.register()
class MFFN_lower_hidden_dims(BasicModelClass):
    def __init__(self):
        super().__init__()
        # NOTE: main MFFN
