...
@DATASETS.register(name="MFFN_huesaturation_te")
class MFFN_huesaturation_TestDataset(_BaseSODDataset):
    def __init__(self, root: Tuple[str, dict], shape: Dict[str, int], interp_cfg: Dict = None):
        ...
        self.contrast_trans1 = A.HueSaturationValue(hue_shift_limit=(20,20), sat_shift_limit=0, val_shift_limit=0, always_apply=True, p=1.0)
        self.contrast_trans2 = A.HueSaturationValue(sat_shift_limit=(20,20), hue_shift_limit=0, val_shift_limit=0, always_apply=True, p=1.0)
    ...
    def __getitem__(self, index):
        ...
        cb1_image = self.contrast_trans1(image=image)["image"]
        cb2_image = self.contrast_trans2(image=image)["image"]
...
@DATASETS.register(name="MFFN_huesaturation_tr")
class MFFN_huesaturation_TrainDataset(_BaseSODDataset):
    def __init__(
