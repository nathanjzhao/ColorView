...
@DATASETS.register(name="MFFN_jittershuffle_te")
class MFFN_jittershuffle_TestDataset(_BaseSODDataset):
    def __init__(self, root: Tuple[str, dict], shape: Dict[str, int], interp_cfg: Dict = None):
        ...
        self.contrast_trans1 = A.ColorJitter(
                ...
                always_apply=True,  # bool
                p=1.0,  # float
            )
        self.contrast_trans2 = A.ChannelShuffle(always_apply=True)
...
@DATASETS.register(name="MFFN_jittershuffle_tr")
class MFFN_jittershuffle_TrainDataset(_BaseSODDataset):
    def __init__(
